...
--save_path /home/zeyi/longtail/longtail_data/generated_data/property_centric/t5_3b_vanilla_w_m.csv --score_path ../output_dir/output_file_t5_3b.json --n_obs 200 --parallelize
