...
../dataset/clean/commongen.1.tgt.txt --constraint_file /home/zeyi/longtail/longtail_data/raw_data/conti/inflection_constraints_t5_infer.json --constraint_file_lemma /home/zeyi/longtail/longtail_data/raw_data/conti/lemma_constraints_t5_infer.json --min_tgt_length 5 \
--max_tgt_length 64 --bs 8 --beam_size 20 --length_penalty 0.1 --ngram_size 3 --prune_factor 50000 --sat_tolerance 2 --beta 1 \
...
--input_path /home/zeyi/longtail/longtail_data/raw_data/conti/inputs_t5_infer.csv --reference_path ../dataset/clean/commongen.1.tgt.txt  \
