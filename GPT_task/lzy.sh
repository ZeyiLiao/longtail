...
# 1
PYTHONPATH=.. python GPT_fill_task.py --inputs ../longtail_data/raw_data/inputs_t5_train.csv \
...
PYTHONPATH=.. python GPT_fill_task.py --inputs ../longtail_data/raw_data/for_dis/inputs_t5_train.csv \
